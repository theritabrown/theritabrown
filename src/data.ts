import type { BioLink, HomepageSection, Product, ProductCollection, Profile } from './types'
...
export const bioLinks: BioLink[] = [
  ...
  },
  {
    ...
    href: 'https://www.instagram.com/theritabrown',
    kind: 'social',
    icon: 'instagram',
    isPrivateStorefront: false,
    isActive: true,
  ...
  },
  {
    ...
    href: 'https://www.tiktok.com/@reinaluxe',
    kind: 'social',
    icon: 'music',
    isPrivateStorefront: false,
    isActive: true,
